...
void FpsControls::add_strafe_code_mp1_gc(Region region, u32 calculate_side_move_address, u32 apply_strafe_force_address, u32 disable_rotation_address, u32 clamp_cur_xy_vel_address, u32 max_speed_array_address) {
  ...
  // addi r1, r1, -0x18
  // blr
  add_code_change(calculate_side_move_address, 0x94210018);
  add_code_change(calculate_side_move_address + 0x04, 0x7c0802a6);
  add_code_change(calculate_side_move_address + 0x08, 0x9001001c);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(calculate_side_move_address + 0x48, 0xd0010010);
  add_code_change(calculate_side_move_address + 0x4c, 0xec210032);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(calculate_side_move_address + 0x68, 0xc0610010);
  add_code_change(calculate_side_move_address + 0x6c, 0xec630828);
  add_code_change(calculate_side_move_address + 0x70, 0xec6307b2);
  add_code_change(calculate_side_move_address + 0x74, 0xec00182a);
  add_code_change(calculate_side_move_address + 0x78, 0xd0010018);
  ...
  add_code_change(calculate_side_move_address + 0x94, 0xc0210004);
  add_code_change(calculate_side_move_address + 0x98, 0xec000828);
  add_code_change(calculate_side_move_address + 0x9c, 0xc0210010);
  add_code_change(calculate_side_move_address + 0xa0, 0xec000824);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(calculate_side_move_address + 0xac, 0x4080000c);
  add_code_change(calculate_side_move_address + 0xb0, 0xfc000890);
  add_code_change(calculate_side_move_address + 0xb4, 0x48000014);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(calculate_side_move_address + 0xc0, 0x40810008);
  add_code_change(calculate_side_move_address + 0xc4, 0xfc000890);
  add_code_change(calculate_side_move_address + 0xc8, 0xc0210014);
  add_code_change(calculate_side_move_address + 0xcc, 0xec200072);
  add_code_change(calculate_side_move_address + 0xd0, 0x8001001c);
  add_code_change(calculate_side_move_address + 0xd4, 0x7c0803a6);
  add_code_change(calculate_side_move_address + 0xd8, 0x3821ffe8);
  ...
  add_code_change(apply_strafe_force_address + 0x08, 0xec3e0828);
  add_code_change(apply_strafe_force_address + 0x0c, 0xfc200a10);
  add_code_change(apply_strafe_force_address + 0x10, 0xfc010040);
  add_code_change(apply_strafe_force_address + 0x14, 0x4081002c);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(apply_strafe_force_address + 0x20, 0x7c651b78);
  add_code_change(apply_strafe_force_address + 0x24, 0x7fa3eb78);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(apply_strafe_force_address + 0x30, 0xd0010014);
  add_code_change(apply_strafe_force_address + 0x34, 0xd0010018);
  add_code_change(apply_strafe_force_address + 0x38, 0x38810010);

  // disable rotation on LR analog
  add_code_change(disable_rotation_address + 0x358, 0x4bfffc71);
  add_code_change(disable_rotation_address, 0x4800000c);
  add_code_change(disable_rotation_address + 0x714, 0x60000000);
  add_code_change(disable_rotation_address + 0x758, 0x60000000);
  add_code_change(disable_rotation_address + 0x3F4, 0x60000000);
  add_code_change(disable_rotation_address + 0x534, 0x60000000);
  add_code_change(disable_rotation_address + 0x600, 0x60000000);

  // Clamp current xy velocity @ clamp_cur_xy_vel_address
  // lfs f1, -0x7ec0(r2)
  // fmuls f0, f30, f30
  // fcmpo cr0, f0, f1
  // ble 0x134
  ...
  add_code_change(clamp_cur_xy_vel_address + 0x04, 0xec1e07b2);
  add_code_change(clamp_cur_xy_vel_address + 0x08, 0xfc000840);
  add_code_change(clamp_cur_xy_vel_address + 0x0c, 0x40810134);
  ...
  add_code_change(clamp_cur_xy_vel_address + 0x30, 0xec200830);
  if (region == Region::NTSC_U) {
    if (version == 0) {
  ...
  add_code_change(clamp_cur_xy_vel_address + 0x3c, 0x7c601a14);
  ...
  for (u32 i = 0; i < 8; i++) {
    add_code_change(max_speed_array_address + i * 4, 0x41480000);
  }
}
